...
public class Append_To_PatternLayout2 {
	//enabling the Logging on the current class
	private static Logger logger = Logger.getLogger(Append_To_PatternLayout2.class);
	
	static {
		try {
			PropertyConfigurator.configure("src/com/nt/commons/log4j_DailyRollingFileAppender.properties");
