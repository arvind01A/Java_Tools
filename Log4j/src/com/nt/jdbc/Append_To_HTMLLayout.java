...
public class Append_To_HTMLLayout {
	//enabling the Logging on the current class
	private static Logger logger = Logger.getLogger(Append_To_HTMLLayout.class);
	
	static {
		try {
			PropertyConfigurator.configure("src/com/nt/commons/log4j_Appender.properties");
