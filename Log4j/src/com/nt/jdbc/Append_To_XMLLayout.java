...
public class Append_To_XMLLayout {
	private static Logger logger = Logger.getLogger(Append_To_XMLLayout.class);
	
	static {
		try {
			PropertyConfigurator.configure("src/com/nt/commons/log4j_Appender_xml.properties");
