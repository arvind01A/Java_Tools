...
public class Append_To_PatternLayout3 {
	private static Logger logger = Logger.getLogger(Append_To_PatternLayout3.class);
	
	static {
		try {
			DOMConfigurator.configure("src/com/nt/commons/log4j_Appender.xml");
